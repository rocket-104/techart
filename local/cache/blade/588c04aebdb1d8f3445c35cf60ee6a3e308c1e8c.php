<div class="<?php echo e($block); ?>">
	...
	<div class="<?php echo e($block->elem('textBlock')); ?>">
		<h2 class="<?php echo e($block->elem('h2')); ?>"><a href="#"><?php echo e($header); ?></a></h2>
		<p class="<?php echo e($block->elem('p')); ?>"><?php echo e($text); ?></p>
	</div>
</div><?php /**PATH /var/www/workspace/test2/www/local/templates/techart/frontend/src/block/common/one_insite/one_insite.blade.php ENDPATH**/ ?>