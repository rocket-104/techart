...
/* infoblock ID=2, code=countries */
class countries extends Infoblock
{
...
return array(
	...
	return array(
            ...
            'DETAIL_PAGE_URL' => '#SITE_DIR#/tours/catalog/#ELEMENT_ID#/',
            'SECTION_PAGE_URL' => '/#SITE_DIR#/tours/',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
            'SECTIONS_NAME' => 'Разделы стран',
            'SECTION_NAME' => 'Раздел стран',
        );
	}
...
return array(
            'ELEMENT_NAME' => 'Страна',
            'ELEMENTS_NAME' => 'Страны',
            'ELEMENT_ADD' => 'Добавить страну',
            'ELEMENT_EDIT' => 'Изменить страну',
            'ELEMENT_DELETE' => 'Удалить страну',
            'SECTION_NAME' => 'Раздел стран',
            'SECTIONS_NAME' => 'Разделы стран',
            'SECTION_ADD' => 'Добавить раздел стран',
            'SECTION_EDIT' => 'Изменить раздел стран',
            'SECTION_DELETE' => 'Удалить раздел стран',
        );
}
